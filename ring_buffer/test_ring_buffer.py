...
class RingBufferTests(unittest.TestCase):
    ...
    def test_ring_buffer_append_handles_length(self):
    ...
    def test_ring_buffer_appends_elements(self):
        self.buffer.append('a')
        self.buffer.append('b')
        self.buffer.append('c')
        self.buffer.append('d')
        ...
        self.assertEqual(str(self.buffer.storage), expected_output)

    def test_ring_buffer_append_handles_overflow(self):
        self.buffer.append('a')
        self.buffer.append('b')
        self.buffer.append('c')
        self.buffer.append('d')
    ...
    def test_ring_buffer_append_handles_current_correctly(self):
        self.buffer.append('a')
        self.buffer.append('b')
        self.buffer.append('c')
        self.buffer.append('d')
        ...
        self.assertEqual(str(self.buffer.current), 'a')

        self.buffer.append('f')
        self.assertEqual(str(self.buffer.current), 'f')
